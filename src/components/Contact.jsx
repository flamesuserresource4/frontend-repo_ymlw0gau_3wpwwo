    ...
    <section id="contact" className="py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.form
          ...
          className="mt-8 grid md:grid-cols-2 gap-5 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-6"
        >
          ...
          <div className="md:col-span-2 flex items-center gap-4">
            <motion.button
              ...
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.98 }}
              className="px-5 py-3 rounded-xl bg-gradient-to-tr from-blue-500 via-sky-500 to-cyan-400 text-white font-medium shadow-[0_8px_40px_0_rgba(56,189,248,0.35)] hover:shadow-[0_8px_50px_0_rgba(56,189,248,0.55)] transition"
            >
              Send message
            </motion.button>
